...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.hgicreate.rno.xdr.backend.domain.Record.class.getName() + ".ids", jcacheConfiguration);
            ...
            cm.createCache(com.hgicreate.rno.xdr.backend.domain.Solve.class.getName(), jcacheConfiguration);
            cm.createCache(com.hgicreate.rno.xdr.backend.domain.Solve.class.getName() + ".taskIds", jcacheConfiguration);
            cm.createCache(com.hgicreate.rno.xdr.backend.domain.Task.class.getName() + ".taskIds", jcacheConfiguration);
            cm.createCache(com.hgicreate.rno.xdr.backend.domain.Record.class.getName() + ".recordIds", jcacheConfiguration);
